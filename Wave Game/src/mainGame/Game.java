...
public class Game extends Canvas implements Runnable {
	...
	public Game() {
		...
		mouseListener = new MouseListener(this, this.handler, this.hud, this.hud2, this.attackHUD, this.spawner, this.spawner2, this.spawner3, this.attackSpawn,
				upgradeScreen, this.player,this.player2, this.upgrades);
