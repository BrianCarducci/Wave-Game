...
public class MouseListener extends MouseAdapter {
	...
	public MouseListener(Game game, Handler handler, HUD hud, CoopHud hud2, ServerHUD serverHUD, AttackHUD attackHUD, Spawn1to5 spawner, Spawn5to10 spawner2, Spawn10to15 spawner3,
			AttackSpawn attackSpawn, UpgradeScreen upgradeScreen, Player player, Player player2, Upgrades upgrades, Server server) {
		this.game 			= game;
		this.handler 		= handler;
		this.hud 			= hud;
		this.hud2			= hud2;
